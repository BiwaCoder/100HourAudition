...
bpy.ops.wm.open_mainfile(filepath=str(P/'SeasideMansion-DetailV3.blend'))
...
for name,loc,target,scale in [('Lantern',(2,-3,1.8),(0,0,.68),1.65),('Sofa',(3,-5,2.6),(0,0,.60),3.4),('ThrowPillow',(1,-2,2.6),(0,0,0),.72),('Table',(3,-4,2.5),(0,0,.4),2.1)]:
